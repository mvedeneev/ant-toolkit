		...
		extends GenericDocbaseTask
{
	...
	private boolean m_maclSecurity = false;

	public void setMacl(boolean maclSecurity)
	{
		m_maclSecurity = maclSecurity;
	}
			...
			throws BuildException
	{
		try
		{
			...
			values.appendString(m_maclSecurity ? "T" : "F");
		...
		{
			throw new BuildException("Failed to set MACL security to " + m_maclSecurity + ":\r\n" + e.toString(), e);
		}
	}
}
