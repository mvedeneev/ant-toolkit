...
public class AclHelper
{
			...
			throws BuildException
	{
			...
			!userName.equals(DM_OWNER))
		{
			...
			{
				throw new BuildException("Failed to revoke permits for user " + userName + "\r\n" + e.toString());
			}
		}
		...
		{
			throw new BuildException("Failed to grant permits to user " + userName + "\r\n" + e.toString());
		}
			...
			throws BuildException
	{
		...
		{
			throw new BuildException("Failed to reset object ACL\r\n" + e.toString());
		}
	}
