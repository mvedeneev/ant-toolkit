		...
		extends DocbaseObjectTask
{
			...
			throws BuildException
	{
		...
		{
			throw new BuildException("Failed to create default folder\r\n" + e.toString());
		}
	}
	...
	private boolean isFolderExist(String folder)
	{
		...
		{
			throw new BuildException("Failed to verify default folder for existens\r\n" + e.toString());
		}
	}
			...
			throws BuildException
	{
		...
		{
			throw new BuildException("Failed to set folder owner\r\n" + e.toString());
		}
