...
public class DocbaseTypesHelper
{
	public static class AttributeInfo
	{
		...
		private int m_dataType = IDfValue.DF_UNDEFINED;
	...
	private static volatile Map<String, List<String>> m_typeInheritanceSequence = new HashMap<String, List<String>>();

	private static volatile Map<String, Map<String, AttributeInfo>> m_typeAttributes = new HashMap<String, Map<String, AttributeInfo>>();
			...
			throws DfException
	{
		...
		synchronized (m_typeInheritanceSequence)
		{
			List<String> inheritanceSequence = m_typeInheritanceSequence.get(typeName);
			...
			m_typeInheritanceSequence.put(typeName, inheritanceSequence);
			...
			throws DfException
	{
		...
		synchronized (m_typeAttributes)
		{
			attrInfo = m_typeAttributes.get(typeName);
			if (attrInfo == null)
			{
				attrInfo = Collections.synchronizedMap(new HashMap<String, AttributeInfo>());
				m_typeAttributes.put(typeName, attrInfo);
			}
		}
