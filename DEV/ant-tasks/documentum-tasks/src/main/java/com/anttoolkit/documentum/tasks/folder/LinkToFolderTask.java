...
public class LinkToFolderTask extends GenericDocbaseTask
{
			...
			throws BuildException
	{
		...
		{
			throw new BuildException("Can't link object r_object_id=" + objectId + " to folder='" + m_folder + "', because it's not of type IDfSysObject");
		}
		...
		{
			throw new BuildException("Failed to link object r_object_id=" + objectId + " to folder='" + m_folder + "'", e);
		}
	}
}
